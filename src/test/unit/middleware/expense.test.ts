...
describe("Expenses Middleware - validateExpenseExist", () => {
  ...
  test("should handle a non-existen budget", async () => {
  ...
  test("should handle internal server error", async () => {
    (Expense.findByPk as jest.Mock).mockRejectedValueOnce(new Error());
  ...
  test("should prevent unauthorized user from adding expenses", async () => {
    const req = createRequest({
      method: "POST",
